...
func main() {
	...
	//meals routes
	router.HandleFunc("/meals", meals.CreateMeal).Methods("POST")
	...
	router.HandleFunc("/meals/{id}/remove/{ingredient_id}", meals.DeleteIngredientFromMeal).Methods("PUT")
	// //mealplan routes
	...
	// router.HandleFunc("/mealplans/{mealplan_id}/remove/{meal_id}", mealplans.DeleteMealFromMealplan).Methods("PUT")
	// //weekplan routes
	...
	// router.HandleFunc("/weekplans/{weekplan_id}/remove/{mealplan_id}", weekplans.DeleteMealplanFromWeekplan).Methods("PUT")
	// //grocery list routes
	...
	// router.HandleFunc("/grocerylists/{grocerylist_id}/remove/{mealplan_id}", grocerylists.DeleteMealplanFromGrocerylist).Methods("PUT")
	...
	// router.HandleFunc("/weeklists/{weeklist_id}/remove/{weekplan_id}", weeklists.DeleteWeekplanFromWeeklist).Methods("PUT")
